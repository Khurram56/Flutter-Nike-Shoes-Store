...
class ProductData {
  static List<Product> getProducts() {
    return [
      ...
      Product(
        imagePath: 'assets/r5.png',
        description: 'New Mens shoes \n \$25.00',
      ),
      Product(
        imagePath: 'assets/r6.png',
        description: 'New Mens shoes \n \$20.00',
      ),
      Product(
        imagePath: 'assets/r7.png',
        description: 'New Mens shoes \n \$35.00',
      ),
      Product(
        imagePath: 'assets/r8.png',
...
class RunningShoesGridView extends StatelessWidget {
              ...
              return GestureDetector(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width / 2 -
                      15, // Adjust the width according to your layout
                  height: MediaQuery.of(context).size.width / 2 -
                      15, // Adjust the height according to your layout
                  child: Column(
                    children: [
                      Expanded(
                        child: Image.asset(
                      ...
                      SizedBox(
                          height: 5), // Add spacing between the image and text
                      Center(
                        child: Text(
